...
export default function CreateCourseModal({ onClose, onCourseCreated }) {
  ...
  const handleCancel = () => {
    ...
    if (hasData) {
      showWarning("Course creation cancelled");
      setTimeout(() => {
        onClose();
      }, 1000);
    } else {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center z-50 p-4">
      ...
      {/* Modal */}
      <AnimatedModal className="relative w-full max-w-2xl h-[90vh]">
        <div className="bg-white/95 backdrop-blur-xl rounded-2xl shadow-2xl border border-white/20 overflow-hidden flex flex-col h-full">
          ...
          <div className="p-6 overflow-y-auto flex-1 min-h-0 scroll-smooth">
            <form onSubmit={handleSubmit} className="space-y-8">
              {/* Title Section */}
              <FadeInUp ref={titleRef} isVisible={titleInView}>
              ...
              {/* Description Section */}
              <FadeInUp ref={descriptionRef} isVisible={descriptionInView} delay={0.1}>
                <div className="space-y-3">
              ...
              {/* Media Section */}
              <FadeInUp ref={mediaRef} isVisible={mediaInView} delay={0.2}>
                <div className="space-y-3">
                  <label className="block text-sm font-semibold text-text flex items-center gap-2">
              ...
              {/* Category and Level */}
              <FadeInUp ref={detailsRef} isVisible={detailsInView} delay={0.3}>
              ...
              {/* Price and Duration */}
              <FadeInUp ref={pricingRef} isVisible={pricingInView} delay={0.4}>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-3">
                    <label className="block text-sm font-semibold text-text flex items-center gap-2">
              ...
              {/* Additional Fields */}
              <FadeInUp ref={additionalRef} isVisible={additionalInView} delay={0.5}>
